...
;fingerswitch.c,51 :: 		TRISB=0xFF;
	MOVLW       255
	MOVWF       TRISB+0 
;fingerswitch.c,52 :: 		TRISC=0x00;               // Set inputs
	CLRF        TRISC+0 
;fingerswitch.c,53 :: 		PORTB=0X00;                  //Initialize PORTS
	CLRF        PORTB+0 
;fingerswitch.c,54 :: 		PORTC=0X00;
	CLRF        PORTC+0 
